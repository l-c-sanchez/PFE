    ...
    data: {
      ...
      parasfirstpart: [
        ...
        { inter: 'Peu de jeux sont centrés sur des personnages féminins',
          message: 'Il y a sept ans, sur un ensemble de 669 jeux d’action, de tir ou de rôle répertoriés par une <a href="http://web.archive.org/web/20131031054125/https://www.penny-arcade.com/report/article/games-with-female-heroes-dont-sell-because-publishers-dont-support-them" target="_blank" >société d’études spécialisée</a>, seuls 4% des productions avaient comme protagoniste principal une femme, et 45% offraient la possibilité de choisir un avatar masculin ou féminin. Mais depuis, que s’est-il passé ? '},
        { 
      ...
      parasthirdpart: [
        ...
        { message: 'Deux ans plus tôt, Anita Sarkeesian, militante féministe à la tête de Feminist Frequency, avait commencé à subir le même déferlement de haine : en lançant un appel aux dons pour produire sur sa chaîne Youtube des vidéos sur la représentation des femmes dans les jeux vidéo, elle reçoit de multiples menaces de mort et de viol. Plusieurs de ses harceleurs créent même un jeu qui consiste à la tabasser virtuellement.'},
        { quote: {
          ...
          message: 'Cette série de polémiques rend visible les femmes du secteur, mais aussi les problèmes qui traversent l’industrie. En parallèle, <i>"les entreprises ont commencé à percevoir que le marché est demandeur de plus de mixité"</i>, estime Fanny Lignon. Sur les forums, nombreuses sont les joueuses à s’interroger, lors de l’annonce d’un jeu, sur la possibilité de choisir le sexe de leur avatar.' }
      ],
