...
var global = new Vue({
    ...
    data: {
      ...
      parasfourthpart: [
        ...
        { message: 'De plus en plus de femmes se dirigent vers ces filières. Leur proportion dans la filière jeu vidéo d’Isart digital, formation française spécialisée, a été multipliée par deux en cinq ans. Une féminisation doublée d’une évolution des mentalités : Charlotte Lavergne, directrice pédagogique, constate <i>"une génération beaucoup plus ouverte que les précédentes"</i>. '},
