...
var global = new Vue({
    ...
    data: {
      ...
      parassecondpart: [
        ...
        { message: 'Pendant de longues années, la représentation des femmes y a été limitée au <i>"principe de la Schtroumpfette"</i>. Autrement dit : <i>"une femme ultra stéréotypée, au milieu de nombreux protagonistes masculins souvent virils"</i>. C’était, par exemple, les figures de princesses à sauver comme Peach que Super Mario devait venir secourir. Ou encore des représentations féminines très sexualisées, destinées au public masculin, comme les combattantes de <i>Mortal Kombat</i>, série de jeux née dans les années 90.',
      ...
      parasthirdpart: [
        ...
        { quote: {
          ...
          message: 'En parallèle, les femmes ont commencé à devenir une cible pour l’industrie du jeu vidéo : à partir des années 2000, plusieurs studios produisent des <a href="https://www.lsa-conso.fr/le-jeu-video-seduit-ajeux mark" target="_blank" >jeux marketés pour les femmes</a> : c’est le cas, notamment, de la série <i>Léa Passion</i> qui propose aux femmes d’incarner une vétérinaire ou encore une maîtresse d’école. <i>"Le marché est demandeur de plus de mixité"</i>, souligne Fanny Lignon. Sur les forums, nombreuses sont les joueuses à s’interroger, lors de l’annonce d’un jeu, sur la possibilité de choisir le sexe de leur avatar.' }
      ],
      players:[
        { name: 'Coralie, 31 ans',
      ...
      parasfourthpart: [
        ...
        { message: 'A La Défense, Thomas Planques fait le même constat. Devant dix-huit étudiants de l\’Institut de l\'Internet et du Multimédia, le directeur créatif décortique les pratiques du secteur, spécialisés dans le jeu vidéo. Narrations sexistes, protagonistes féminines créées comme des copies de leurs homologues masculins… <i>"Féminiser un personnage en lui mettant un noeud dans les cheveux, ça me paraît dommage"</i>, soupire Florian, au deuxième rang. L\’enseignant acquiesce : <i>"Vous avez une autoroute pour faire changer les choses"</i>.'}
      ],
      gameTable: {
