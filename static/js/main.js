...
var global = new Vue({
    ...
    data: {
      ...
      parasfourthpart: [
        ...
        { message: 'Un peu plus loin, Hannah Flynn présente <i>Sunless Skies</i>, le dernier jeu de rôle de son entreprise londonienne. La trentenaire aux cheveux indique qu’il était <i>"naturel pour le studio de proposer aux joueurs de choisir leur genre, car nous avons une petite équipe mixte et diversifiée"</i>.'},
        ...
        { message: '<i>"Féminiser un personnage en lui mettant un personnage dans les cheveux, ça me paraît dommage"</i>, soupire Florian devant ses camarades. Etudiant en jeux vidéo, le jeune homme assiste au cours "Jeux vidéo et stéréotypes" que Thomas Planques, producteur et directeur créatif, vient donner chaque année dans son école parisienne. Pendant quatre heures, le professionnel - qui est déjà intervenu dans une dizaine d’établissements - décortique les pratiques qui confinent les femmes à des personnages sexualisés ou à sauver. Personnages féminins créés comme des copies conformes de leurs homologues masculins, mécanismes de jeu sexistes… <i>"Vous avez une autoroute pour faire changer les choses"</i>, lance l’enseignant.'}
      ],
      gameTable: {
