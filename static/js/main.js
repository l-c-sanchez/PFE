    ...
    data: {
      ...
      parasthirdpart: [
        ...
        { quote: {
          ...
          message: 'Leur acharnement  rend visible les femmes du milieu du jeu vidéo et pointe, une nouvelle fois, la misogynie du secteur. Plusieurs acteurs de l’industrie se rendent compte de la nécessité d’agir. Dans <a href="https://www.gamasutra.com/view/news/224400/Gamers_dont_have_to_be_your_audience_Gamers_are_over.php"target="_blank" >une tribune</a>, la journaliste spécialisée Leigh Alexander s’attaque à l’immaturité des “gamers” et appelle à la création de jeux plus diversifiés.'},
        { 
          message: 'En parallèle, les femmes ont commencé à devenir une cible sur le marché du jeu vidéo : à partir des années 2000, plusieurs studios produisent des <a href="https://www.lsa-conso.fr/le-jeu-video-seduit-ajeux mark" target="_blank" >jeux marketés pour les femmes</a> : c’est le cas, notamment, de la série <i>Léa Passion</i> qui propose aux femmes d’incarner une vétérinaire ou encore une maîtresse d’école. <i>"Le public est demandeur de plus de mixité"</i>, souligne Fanny Lignon. Sur les forums, nombreuses sont les joueuses à s’interroger, lors de l’annonce d’un jeu, sur la possibilité de choisir le sexe de leur avatar.' }
      ],
      players:[
        { name: 'Coralie, 31 ans',
