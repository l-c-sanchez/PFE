...
var global = new Vue({
    ...
    data: {
      ...
      chapo: 'L’E3, le plus important salon de jeu vidéo au monde, se tiendra le 6 juin. L’année dernière, de nombreuses créations mettant en avant des personnages féminins forts et peu stéréotypés y ont été présentées. Un changement notable, même si l’amélioration de la présence et de la représentation des femmes reste encore mesurée.',
      parasfirstpart: [
        ...
        { inter: 'Peu de jeux sont centrés sur des personnages féminins',
          message: 'Il y a sept ans, sur un ensemble de 669 jeux d’action, de tir ou de rôle répertoriés par une <a href="http://web.archive.org/web/20131031054125/https://www.penny-arcade.com/report/article/games-with-female-heroes-dont-sell-because-publishers-dont-support-them" target="_blank" >société d’études</a>, seuls 4% avaient comme protagoniste principal une femme, et 45% offraient la possibilité de choisir un avatar masculin ou féminin. Mais depuis, que s’est-il passé ?'},
        { 
          message: 'Selon l’organisation américaine <a target="_blank" href="https://feministfrequency.com/2018/06/14/gender-breakdown-of-games-featured-at-e3-2018/">Feminist Frequency</a>, en 2018, les jeux présentés à l\’E3 proposaient toujours <i>"trois fois plus de personnages jouables masculins que féminins"</i>. Chaque année, cette association féministe publie sur son site un rapport dédié au salon californien. Comme elle, nous avons collecté des informations sur les projets présents à l’E3 chaque année depuis 2016. A-t-on la possibilité d\’y jouer une femme, un homme ? Ou les deux ?'}
      ],
      dataviz: {
      ...
      parassecondpart: [
        { message: 'Résultat : en 2018, comme en 2016, la majorité des jeux répertoriés propose de choisir le genre de son avatar, ou d’alterner entre des avatars féminins et masculins. Les créations centrées sur un personnage masculin sont trois fois plus nombreuses que celles qui mettent à l’affiche des femmes exclusivement. Ces dernières atteignent 7% du total - un pourcentage stable sur la période étudiée.'},
        { inter: 'Une évolution "à petits pas"',
          message: 'Des résultats qui ne surprennent pas Fanny Lignon. Pour cette chercheuse de l’université Lyon 1, directrice de l’ouvrage <i>Genre et jeux vidéo</i>, l’industrie du jeu vidéo est en train de bouger - mais <i>"à petits pas"</i>.' },
        { message: 'Pendant de longues années, la représentation des femmes y a été limitée au <i>"principe de la Schtroumpfette"</i>. Autrement dit : <i>"une femme ultra stéréotypée, au milieu de nombreux protagonistes masculins souvent virils"</i>. C’était, par exemple, les figures de princesses comme Peach que Super Mario devait venir secourir. Ou encore des représentations féminines très sexualisées, destinées au public masculin, comme les combattantes de <i>Mortal Kombat</i>, série de jeux née dans les années 1990.',
      ...
      learn_more: [
        ...
        },
        {
          ...
          id:"misspacman",
          message: 'Qui ne connaît pas Pac-Man ? Le jeu japonais, sorti dans les années 1980, consiste à faire manger le plus de pac-gommes possibles à son personnage - une simple boule jaune - tout en évitant les fantômes. <br><br>Succès planétaire, le jeu d’arcade est aussi l’un des premiers à intégrer une "héroïne". En 1981, Ms. Pac-Man fait son apparition. <i>"La seule manière qui a été trouvée pour transformer Pac-Man en fille, c’est de lui mettre un noeud et du rouge à lèvres"</i>, soupire la chercheuse Fanny Lignon. <iframe width="560" height="315" src="https://www.youtube.com/embed/HQv0zAXDCo8?start=483" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
        }
      ],
      parasthirdpart: [
      ...
      parasfourthpart: [
        { message: 'En France, un <a href="https://www.tns-sofres.com/publications/les-pratiques-de-consommation-de-jeux-video-des-francais" target="_blank" >rapport publié par le CNC en 2013</a> (Centre National du Cinéma et de l’image animée) estime que les femmes consomment plus de jeux vidéo familiaux ou de stratégie, les hommes étant plus nombreux à pratiquer les jeux de tir ou d’action. Toutes catégories de joueurs et tous supports confondus, les femmes représentent 49% des amateurs de jeux vidéo.'},
        { message: 'Malgré ce pourcentage important, l’évolution du marché reste mesurée. Les créateurs doivent composer avec une partie des joueurs, très attachée à ses <i>"standards"</i> de masculinité. En témoigne l\’indignation de certains hommes, quand Electronic Arts a présenté l\’an passé son dernier <i>Battlefield</i>, qui intègre des femmes soldats.',
          ...
          { quote: {
            ...
            message: '<i>"Soit ils l\'acceptent... ou alors ils n\'achètent pas le jeu !"</i>, a réagi le directeur créatif de l’éditeur américain dans le média spécialisé <a target="_blank" href="https://www.gamasutra.com/view/news/319787/This_is_not_okay_EA_minces_no_words_on_backlash_against_women_in_Battlefield.php">Gamasutra</a>.'},
        { message: 'Une position affirmée que ne partagent pas tous les acteurs du secteur. La populaire plateforme de distribution de jeux vidéo Steam a réagi très mollement, en mars, au scandale né de <i><a  target="_blank" href="http://www.francesoir.fr/societe-science-tech/rape-day-le-jeu-video-proposant-de-violer-des-femmes-finalement-retire">Rape day</a></i>. Ce jeu, dont la sortie était prévue en avril, était centré sur le principe suivant : <i>"Harcelez verbalement, tuez et violez des femmes pour progresser dans l’histoire"</i>.',
          img: [{
        ...
        { message: '<i>"L’industrie est encore dans une phase de prise de conscience"</i>, constate Marie-Lou Dulac. Cette cheffe de projet éditorial travaille depuis presque deux ans chez Ubisoft. L\’une de ses missions : faire un travail de recherche, pour amener ses collègues à <i>"faire le constat"</i> des lacunes en matière de représentation des femmes. Elle organise par exemple des ateliers de sensibilisation.  <i>"Certaines personnes sont réfractaires, elles disent que les filles ne sont pas notre cœur de cible, que c’est du travail en plus"</i>, confie-t-elle.'},
          ...
          message: 'Il y a cinq ans, le directeur technique d\’Ubisoft avait d’ailleurs utilisé cet argument pour défendre <i>Assassin’s Creed : Unity</i>, critiqué pour ne proposer que des avatars masculins dans un mode de jeu en ligne. <i>"Un personnage féminin, ça aurait signifié refaire beaucoup d’animation, beaucoup de costumes"</i>, avait-il déclaré au <a target="_blank" href="https://www.videogamer.com/news/no_female_leads_in_assassins_creed_unity_unfortunate_but_a_reality_of_game_development_ubi">site Video Gamer</a>. D\’autres employés du studio avaient remis cette déclaration en cause, dont un directeur d’animation qui avait estimé <a href="https://twitter.com/GameAnim/status/476638349097058304" target="_blank" >sur Twitter</a> la charge de travail à <i>"un ou deux jours"</i> seulement.'},
        { inter: '"Vous ne pouvez pas avoir d’héroïne dans les jeux vidéo"',
          message: '<i>"Beaucoup de développeurs ont la capacité de se remettre en question. Mais c’est difficile à concrétiser au sein de grosses entreprises</i>, explique Sybil Collas, professionnelle du secteur. <i>Le jeu vidéo est une industrie à but de monétisation et les studios et les éditeurs ont tendance à garder toujours la même ‘recette’, pour ne pas prendre de risque"</i>. Spécialisée dans la narration, elle travaille notamment pour Dontnod Entertainment.'},
        { message: 'Ce studio parisien dit avoir essuyé les refus de nombreux éditeurs pour son jeu d’action <i>Remember Me</i>, sorti en 2014. En cause : Nilin, son héroïne amnésique. <i>"Certains nous ont dit : \‘nous ne désirons pas éditer votre jeu parce qu’il ne sera pas un succès. Vous ne pouvez pas avoir d’héroïne dans les jeux vidéo. Ce doit être un héros.\’"</i>, dénonçait en 2013 l’un des <a target="_blank"  href="http://web.archive.org/web/20130410205807/https://www.penny-arcade.com/report/article/remember-mes-surprising-connection-to-facebook-and-why-its-protagonist-had"> cofondateurs du studio<a>.'
        },
        { message: 'La production suivante de Dontnod Entertainment, <i>Life is Strange</i>, rencontre <a target="_blank"  href="https://www.youtube.com/watch?v=t2Hr_LbIM2E">les mêmes problèmes</a>. Publiée en 2015, elle met elle aussi en avant une protagoniste féminine. <i>"Les éditeurs avaient du mal à croire que ça intéresserait les joueurs"</i>, s\’insurge Sybil Collas. Pour elle, comme pour les autres spécialistes interrogés, les studios indépendants sont plus enclins à s’affranchir des modèles et des narrations traditionnels que les mastodontes du secteur - qui consacrent souvent plusieurs années et des millions de dollars à la production d’un seul jeu.'},
        ...
        { message: 'A l\’Institut de l\'Internet et du Multimédia de La Défense, Thomas Planques fait le même constat. Devant 18 étudiants spécialisés dans le jeu vidéo, ce directeur créatif décortique les pratiques du secteur. Protagonistes féminines créées comme des copies de leurs homologues masculins, narrations sexistes… <i>"Jouer un personnage masculin hyper viril qui va sauver une fille, ça ne me fait pas rêver"</i>, soupire Florian, au deuxième rang. <i>"Vous avez une autoroute pour faire changer les choses"</i>, acquiesce l’enseignant.'}
      ],
      gameTable: {
